...
public class ToolTipsHandler
{
	...
	private static Panel setToolTipAt(JComponent relativeTo, Panel component, TooltipLocation loc)
	{
		@SuppressWarnings("serial")
		Panel panel = new Panel() {
			@Override public void paintComponent(Graphics g)
			{
				// Don't need to draw anything - Just doing this to stop the Panel from drawing anything
//				Graphics2D g2d = (Graphics2D)g;
//				
//				g2d.setColor(Colour.toAWTColor(Main.Theme.THEME_BACK_DARK));
//				
//				int[] xpoints = { 0, TOOLTIPS_SHADOW_SIZE * 4, TOOLTIPS_SHADOW_SIZE * 4 };
//				int[] ypoints = { (int)(getHeight() * 0.5f), (int)(getHeight() * 0.5f) + 5, (int)(getHeight() * 0.5f) - 5 };
//				
